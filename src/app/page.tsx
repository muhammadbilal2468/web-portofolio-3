  ...
  return (
    <div className="realative w-full bg-primary overflow-hidden">
      ...
      <div className="relative w-full lg:h-screen h-fit sm:pt-40">
        ...
        {/* Tombol Humburger */}
        {isMenuOpen && (
          <button className="flex items-center justify-center fixed left-5 top-5 text-[10px] text-white px-3 py-0.5 bg-quaternary rounded-md font-bold cursor-pointer z-50">
